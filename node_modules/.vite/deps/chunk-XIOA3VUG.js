import {
  script as script10,
  script2 as script12
} from "./chunk-CNXSRFGB.js";
import {
  script as script11
} from "./chunk-3YYC4EPL.js";
import {
  script as script9
  ...
  methods: {
    ...
    findSelectedOptionIndex: function findSelectedOptionIndex() {
      ...
      return this.$filled ? this.visibleOptions.findIndex(function(option2) {
        return _this15.isValidSelectedOption(option2);
      }) : -1;
    },
    ...
    searchOptions: function searchOptions(event, _char) {
      ...
      if (isNotEmpty(this.searchValue)) {
        optionIndex = this.visibleOptions.findIndex(function(option2) {
          return _this16.isOptionExactMatched(option2);
        });
        if (optionIndex === -1) {
          optionIndex = this.visibleOptions.findIndex(function(option2) {
            return _this16.isOptionStartsWith(option2);
          });
        }
        if (optionIndex !== -1) {
          matched = true;
    ...
    flatOptions: function flatOptions(options2) {
      ...
      return (options2 || []).reduce(function(result, option2, index) {
        ...
        var optionGroupChildren = _this18.getOptionGroupChildren(option2);
...
//# sourceMappingURL=chunk-XIOA3VUG.js.map
