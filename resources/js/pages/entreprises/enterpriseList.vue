<template>
  <div>
              ...
              <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                  ...
                  >
                    ...
                    <a href="/admin/stepper" class="btn btn-primary">
                ...
                >
                  <thead>
                    ...
                    >
                      ...
                      <th class="min-w-125px">RCCM</th>
                      <th class="min-w-125px">Identification Nationale</th>
                      <th class="min-w-125px">Num Impot</th>
                      <th class="min-w-125px">Autorisation</th>
                    ...
                    >
                      <tr>
                        ...
                        >
                          <span
                            :class="
                              entreprise.description ? '' : 'text-gray-400'
                            "
                          >
                        ...
                        <td
                          ...
                          data-bs-target="#info-modal"
                        >
                          {{ entreprise.national_identification || "-" }}
                        </td>
                        <td
                          @click="editModal(enterprise)"
                          data-bs-toggle="modal"
                          ...
                          >
                            <div class="menu-item px-3">
                              <a href="#" class="menu-link px-3">
                                <i class="ki-duotone ki-information-2 fs-3"
                                  ><span class="path1"></span
                                  ><span class="path2"></span
                                ></i>
                                Infos
    ...
    <modal-component
      ...
      activeBtn="false"
    >
      <template #title>Création d'une entreprise</template>
      <template #body>
        <initEntreprise @callback="CloseModal" />
      </template>
    </modal-component>
    <!-- End modal template  -->
  </div>
...
import initEntreprise from "./initEntreprise.vue";
...
export default {
  ...
  setup() {
    const { entreprises, getEntreprise, storeEntreprise } = useEntreprises();
    onMounted(async () => {
