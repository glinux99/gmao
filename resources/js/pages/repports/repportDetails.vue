<template>
    <div id="content" class="login-page">
        <vue3-html2pdf :show-layout="false" pdf-orientation="landscape" pdf-content-width="100%" :pdf-quality="2"
            :float-layout="true" :enable-download="false" :manual-pagination="false"  :paginate-elements-by-height="1100"
            :preview-modal="false" @progress="onProgress" @hasStartedGeneration="hasStartedGeneration"
            @beforeDownload="beforeDownload" @hasGenerated="hasGenerated" ref="html2Pdf"   >
            <template v-slot:pdf-content>
                <!-- PDF Content Here -->
                <div id="contentPrint">
                    <div
                        class="d-flex justify-content-between align-items-center mb-3 border-bottom border-warning border-2">
                    ...
                    <div class="d-flex d-none justify-content-between" id="exportPdf">
                        <div>
                    ...
                    <div
                        ...
                        <div class="w-75">
                            <div class="card me-5">
                                ...
                                <Chart type="bar" :data="chartData" :options="chartOptions" class="barGph w-75" />
                        ...
                        <div class="w-25">
                            <!--begin::Card widget 3-->
                            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-50"
                                style="
                  ...
                  ">
                      ...
                      ">
                                        <i class="ki-duotone ki-bank text-white fs-2qx lh-0"><span
                    ...
                    ">
                                    <!--begin::Progress-->
                                    <div
                                        class="fw-bold text-white py-2 d-flex flex-row align-items-center justify-content-center">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-xl-12 w-100">
                            <div class="card my-2 d-flex flex-column">
                                <div class="m-5">
                                    <h3>Déplacement des équipes </h3>
                                    <hr>
                                </div>
                                <Chart type="bar" :data="chartData2" :options="chartOptions" class="barGph w-75 mh-25px" />
                                ...
                                <div v-if="item.materials && item.materials.length > 0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex flex-column">
                                            ...
                                            <span
                                                v-if="item.engin ? item.engin.engin_details && item.engin.engin_details.length > 0 : false"
                                                class="d-flex align-items-center">
                                                <i class="ki-duotone ki-fasten fs-2 me-2">
                                                    <span class="path1"></span><span class="path2"></span>
                                                </i>
                                                Kilométrage Début: {{ item.engin.engin_details[0].kilometrage_debut }}
                                                kmh
                                            </span>
                                            <span
                                                v-if="item.engin ? item.engin.engin_details && item.engin.engin_details.length > 0 : false"
        ...
        <div id="contentPrint">
            ...
            <div class="d-flex justify-content-between" id="exportPdf">
                ...
                <div>
                    <Button severity="success" id="exportPdf" @click="generateReport">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="w-100">
                    <div class="card my-2">
                        ...
                        <Chart type="bar" :data="chartData2" :options="chartOptions" class="barGph w-75" />
...
export default {
    ...
    setup() {
        ...
        const pdfOptions = {
                margin: [10, 10, 10, 10],
                filename: `export_maintenance.pdf`,
                image: {
                    type: 'jpeg',
                    quality: 0.98
                },
                ...
                jsPDF: {
                    unit: 'in',
                    format: 'a4',
                    orientation: 'l' // Default to portrait
                }
            };
  ...
  await html2pdf()
    ...
    .save();
            // await html2pdf().set(pdfOptions).from(pdfContent).toPdf().get('pdf').then((pdf) => {
            //     const totalPages = pdf.internal.getNumberOfPages();
            //     for (let i = 0; i <= totalPages; i++) {
            //         pdf.setPage(i);
            //         if (i <= 2) {
            //             pdf.internal.pageSize.width = 11.69;
            //             pdf.internal.pageSize.height = 8.27;
            //             pdf.internal.pageSize.orientation = "l";
            //             pdf.internal.pageSize.recalculatePageDimensions();
            //         } else {
            //             pdf.internal.pageSize.width = 8.27; // portrait width (A4 in inches)
            //             pdf.internal.pageSize.height = 11.69; // portrait height (A4 in inches)
            //             pdf.internal.pageSize.orientation = "p";
            //             pdf.internal.pageSize.recalculatePageDimensions();
            //         }
