      ...
      <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
          <div id="kt_app_toolbar" class="app-toolbar pb-3 pb-lg-6">
            <div class="d-flex align-items-end justify-content-end gap-2 gap-lg-3">
              <!-- Toggle View Button -->
              <button v-if="!showTableView"
                type="button"
                      ...
                      >
                        <span class="flex items-center gap-2">
                          <div
                            ...
                            v-if="(task.assignToType = 'team')"
                          >
                            {{ getAssingedTeamName(task.assigned_team) }}
                          </div>
  ...
  export default {
    ...
    setup() {
      ...
      const getAssingedTeamName = (team) => {
        if (team != null) {
          return `${team.user.name ?? ""} ${team.user.post_name ?? ""} ${
            team.user.nickname ?? ""
          }`;
        }
        return "N/A";
