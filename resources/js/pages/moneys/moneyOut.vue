                ...
                <div class="card-title">
                  <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input
                      ...
                      placeholder="chercher une depense"
                    />
                  </div>
                </div>
              ...
              <div class="card-body py-4">
                ...
                >
                  ...
                  <tbody class="text-gray-600 fw-semibold">
                    ...
                    <template v-for="otherentrie in expenditures" :key="otherentrie.id">
                      <tr>
                        <td>
                          <div
...
import useExpenditures from "../../services/outmonnaieservices.js";
export default {
  components: {
    modalComponent,
    // categoryAdd,
  ...
  setup() {
    ...
    const { getExpenditures, storeExpenditures, expenditures } = useExpenditures();
