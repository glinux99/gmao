            ...
            >
              ...
              <li class="nav-item mt-2">
                <a
                  ...
                  href="../demo1/account/security.html"
                >
                  Security
                </a>
              </li>
              ...
              <li class="nav-item mt-2">
                <a
                  class="nav-link text-active-primary ms-0 me-10 py-5"
                  href="../demo1/account/activity.html"
                >
                  Activity
                </a>
              </li>
              ...
              <li class="nav-item mt-2">
                <a
                  class="nav-link text-active-primary ms-0 me-10 py-5"
                  href="../demo1/account/api-keys.html"
                >
                  API Keys
                </a>
              </li>
            ...
            <div class="card card-xxl-stretch mb-5 mb-xl-10">
              ...
              <div class="card-header card-header-stretch">
                ...
                <div class="card-toolbar">
                  <ul
                    class="nav nav-tabs nav-line-tabs nav-stretch border-transparent fs-5 fw-bold"
                  ...
                  >
                    ...
                    <div class="row p-0 mb-5 px-9">
                      ...
                      <div class="col">
                        ...
                        >
                          <span class="fs-4 fw-semibold text-success d-block"
                            >User Sign-in</span
                          >
                          <span
                            class="fs-2hx fw-bold text-gray-900"
                            data-kt-countup="true"
                      ...
                      <div class="col">
                        <div
                          class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3"
                        >
                          <span class="fs-4 fw-semibold text-primary d-block"
                            >Admin Sign-in</span
                          >
                          <span
                            class="fs-2hx fw-bold text-gray-900"
                      ...
                      <div class="col">
                        <div
                          class="border border-dashed border-gray-300 text-center min-w-125px rounded pt-4 pb-2 my-3"
                        >
                          <span class="fs-4 fw-semibold text-danger d-block"
                    ...
                    <div class="pt-2">
                      ...
                      <div class="d-flex align-items-center pb-6 px-9">
                        ...
                        <!--begin::Nav pills-->
                        <ul
                          class="nav nav-pills nav-line-pills border rounded p-1"
                        >
                          <li class="nav-item me-2">
                            <a
                              class="nav-link btn btn-active-light btn-active-color-gray-700 btn-color-gray-400 py-2 px-5 fs-6 fw-semibold active"
                              data-bs-toggle="tab"
                          ...
                          <li class="nav-item">
                            <a
                              class="nav-link btn btn-active-light btn-active-color-gray-700 btn-color-gray-400 py-2 px-5 fs-6 fw-semibold"
                              data-bs-toggle="tab"
                    ...
                    <div class="row p-0 mb-5 px-9">
                      ...
                      <div class="col">
                        ...
                        >
                          ...
                          >
                          <span
                            class="fs-2hx fw-bold text-gray-800"
                            data-kt-countup="true"
                  ...
                  >
                    ...
                    <div class="row p-0 mb-5 px-9">
                      ...
                      <div class="col">
                        ...
                        >
                          <span
                            class="fs-lg-4 fs-6 fw-semibold text-success d-block"
                            >User Sign-in</span
                          >

                          <span
                            class="fs-lg-2hx fs-2 fw-bold text-gray-800"
                            data-kt-countup="true"
                      ...
                      <div class="col">
                        ...
                        >
                          <span
                            class="fs-lg-4 fs-6 fw-semibold text-primary d-block"
                            >Admin Sign-in</span
                          >
                      ...
                      <div class="col">
                        ...
                        >
                          <span
                            class="fs-lg-4 fs-6 fw-semibold text-danger d-block"
                            >Failed Attempts</span
                          >
                    ...
                    <div class="pt-2">
                      ...
                      <div class="d-flex align-items-center pb-9 px-9">
                        ...
                        >
                          <li class="nav-item me-2">
                            <a
                              class="nav-link btn btn-active-light py-2 px-5 fs-6 btn-active-color-gray-700 btn-color-gray-400 fw-semibold active"
                              data-bs-toggle="tab"
                          ...
                          <li class="nav-item">
                            <a
                              class="nav-link btn btn-active-light py-2 px-5 btn-active-color-gray-700 btn-color-gray-400 fs-6 fw-semibold"
                              data-bs-toggle="tab"
                      ...
                      <div class="carousel-wrapper">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                          ...
                          <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                            In the last year, you’ve probably had to adapt to
                        ...
                        <div class="d-flex flex-stack pt-8">
                          <span
                            class="badge badge-light-primary fs-7 fw-bold me-2"
                            >Jun 10, 2021</span
                          >
                    ...
                    <div class="carousel-item">
                      ...
                      <div class="carousel-wrapper">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                          ...
                          <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                            As we approach one year of working remotely, we
                            wanted to take a look back and share some ways teams
                            around the world have collaborated effectively.
                          </p>
                        </div>
                        <!--end::Description-->
                        ...
                        <div class="d-flex flex-stack pt-8">
                          ...
                          <a
                            href="#"
                            class="btn btn-light btn-sm btn-color-muted fs-7 fw-bold px-5"
                            >Join</a
                          >
                        </div>
                        <!--end::Summary-->
                      ...
                      <div class="carousel-wrapper">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                          ...
                          <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                            ...
                            certification opportunity which is designed to teach
                            you everything
                          </p>
                        </div>
                        <!--end::Description-->
                  ...
                  <div class="carousel-inner pt-6">
                    ...
                    <div class="carousel-item active">
                      ...
                      <div class="carousel-wrapper">
                        ...
                        <!--begin::Summary-->
                        <div class="d-flex flex-stack pt-8">
                          <span class="text-muted fw-semibold fs-6 pe-2"
                            >34, Soho Avenue, Tokio</span
                          >
        ...
        <div class="card">
          ...
          <div class="card-body p-0">
            ...
            <div class="table-responsive">
              <!--begin::Table-->
              <table
                class="table align-middle table-row-bordered table-row-solid gy-4"
                  ...
                  <tr>
                    ...
                    <td class="ps-5">
                      <button
                        type="button"
                        data-action="copy"
                        class="btn btn-active-color-primary btn-icon btn-color-gray-400 btn-sm btn-outline-light d-"
                      >
