              ...
              <div class="d-flex flex-stack flex-grow-1">
                ...
                <div class="fw-semibold">
                  <div class="fs-6 text-gray-700">
                    ...
                    amazing and create outstanding products to serve your
                    clients <a class="fw-bold" href="#">Learn More</a>.
                  </div>
                </div>
                <!--end::Content-->
              </div>
                ...
                <tbody class="fs-6 fw-semibold text-gray-600">
                  <tr>
                    ...
                    <td>
                      <button
                        data-action="copy"
                        class="btn btn-active-color-primary btn-color-gray-400 btn-icon btn-sm btn-outline-light"
                      >
                    ...
                    <td>
                      <button
                        data-action="copy"
                        class="btn btn-color-gray-400 btn-active-color-primary btn-icon btn-sm btn-outline-light"
                      >
