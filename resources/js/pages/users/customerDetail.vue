        ...
        <div class="d-flex flex-column flex-xl-row">
          ...
          <div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
            ...
            <div class="card mb-5 mb-xl-8">
              ...
              <!--begin::Card footer-->
              <div
                class="card-footer border-0 d-flex justify-content-center pt-0"
              >
                        ...
                        <tr>
                          ...
                          <td class="pe-0 text-end">
                            ...
                            >
                              ...
                              <div class="menu-item px-3">
                                <a
                                  href="../demo1/apps/customers/view.html"
                          ...
                          <div class="flex-equal me-5">
                            <table class="table table-flush fw-semibold gy-1">
                              ...
                              <tr>
                                ...
                                <td class="text-gray-800">**** 5553</td>
                              </tr>
                              <tr>
                                <td class="text-muted min-w-125px w-125px">
                                  Expires
                          ...
                          <div class="flex-equal me-5">
                            <table class="table table-flush fw-semibold gy-1">
                              ...
                              <tr>
                                ...
                                <td class="text-gray-800">**** 6064</td>
                              </tr>
                              <tr>
                                <td class="text-muted min-w-125px w-125px">
                                  Expires
                            ...
                            <table class="table table-flush fw-semibold gy-1">
                              ...
                              <tr>
                                ...
                                <td class="text-gray-800">
                                  Passed
                                  <i
                                    class="ki-duotone ki-check fs-2 text-success"
                                  ></i>
                                </td>
                              </tr>
                            </table>
                          ...
                          <div class="flex-equal me-5">
                            <table class="table table-flush fw-semibold gy-1">
                              ...
                              <tr>
                                ...
                                <td class="text-gray-800">**** 2338</td>
                              </tr>
                              <tr>
                                <td class="text-muted min-w-125px w-125px">
                                  Expires
                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            <td>POST /v1/invoice/in_2093_4283/invalid</td>
                          ...
                          <tr>
                            ...
                            <td>POST /v1/customer/c_64be0d32c0e7e/not_found</td>
                            <td class="pe-0 text-end min-w-200px">
                          ...
                          <tr>
                            ...
                            <td>POST /v1/invoices/in_2162_1079/payment</td>
                            <td class="pe-0 text-end min-w-200px">
                          ...
                          <tr>
                            ...
                            <td>POST /v1/invoices/in_7193_7168/payment</td>
                            <td class="pe-0 text-end min-w-200px">
                              22 Sep 2023, 5:30 pm
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>POST /v1/customer/c_64be0d32c0e80/not_found</td>
                            <td class="pe-0 text-end min-w-200px">
                              20 Dec 2023, 11:30 am
                            </td>
                          </tr>
                          <tr>
                            <td class="min-w-70px">
                            ...
                            <td>POST /v1/invoices/in_7761_9896/payment</td>
                            <td class="pe-0 text-end min-w-200px">
                              20 Jun 2023, 6:43 am
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>POST /v1/invoice/in_5859_7137/invalid</td>
                            <td class="pe-0 text-end min-w-200px">
                              22 Sep 2023, 8:43 pm
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td>POST /v1/invoice/in_6902_4518/invalid</td>
                            <td class="pe-0 text-end min-w-200px">
                          ...
                          <tr>
                            ...
                            <td>POST /v1/invoices/in_2560_2140/payment</td>
                            <td class="pe-0 text-end min-w-200px">
                              25 Jul 2023, 10:10 pm
                            </td>
                          </tr>
                          <tr>
                            <td class="min-w-70px">
                      ...
                      <tbody>
                        <tr>
                          <td class="min-w-400px">
                            ...
                            <a
                              href="#"
                              class="fw-bold text-gray-900 text-hover-primary me-1"
                              >#LOP-45640</a
                            >
                            has been
                            <span class="badge badge-light-danger"
                        ...
                        <tr>
                          <td class="min-w-400px">
                            <a
                              href="#"
                              class="text-gray-600 text-hover-primary me-1"
                              >Sean Bean</a
                            >
                            has made payment to
                            <a
              ...
              <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_adjust_balance_form" class="form" action="#">
                  ...
                  <div class="fs-7 text-muted mb-15">
                    ...
                    maintain your invoices and receipts until then. Thank you.
                  </div>
                  <!--end::Disclaimer-->
                ...
                <div class="modal-body py-10 px-lg-17">
                  ...
                  >
                    ...
                    >
                      <!--begin::Icon-->
                      <i
                        class="ki-duotone ki-information fs-2tx text-primary me-4"
                        ><span class="path1"></span><span class="path2"></span
                        ><span class="path3"></span
                      ></i>
                      <!--end::Icon-->
                    ...
                    <div
                      class="fw-bold fs-3 rotate collapsible collapsed mb-7"
                      data-bs-toggle="collapse"
