<template>
    <form class="form w-100" @submit.prevent="submitForm">
        <div class="text-center mb-10">
            <h1 class="text-dark fw-bold fs-2 mb-3">
                Connection
            </h1>
        </div>
        <div class="fv-row mb-3">
            <label class="form-label fs-6 fw-bold text-dark">Email</label>
            <input class="form-control form-control-lg form-control-solid" type="text" v-model="form.email" placeholder="Saissez votre addresse email"
        ...
        <div class="fv-row mb-10">
            ...
            <div class="row mb-8 d-flex align-items-stretch justify-content-between">
                ...
                <div class="col-6 d-flex align-items-stretch justify-content-end">
                    <a href="/" class="link-info fs-6 fw-bold">
                        Mot de passe oublie
                    </a>
                </div>
            </div>
