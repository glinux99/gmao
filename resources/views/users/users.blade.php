    ...
    <div class="card" data-select2-id="select2-data-156-v9nn">
        ...
        <div class="card-body py-4">
            ...
            ">
                                ...
                                <th class="text-center min-w-75px sorting_disabled" rowspan="1" colspan="1"
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            ...
                            <tr class="odd">
                                ...
                                <td data-order="2023-10-07T02:43:51+02:00">
                                    @if ($user->id != Auth::id())
                                    <div class="badge badge-light fw-bold small">
                                        {{ $user->connections->count()>0 ?

                                        (now()->diffForHumans($user->connections->last()->updated_at)) : "Aucune
                                        connection"}}
                                    </div>
                                    @else
                                ...
                                <td data-order="{{$user->created_at}}" class="text-center">
                                    {{
                                    $user->number ?? "-"
                                    }}
                                </td>
