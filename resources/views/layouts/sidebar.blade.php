...
<div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="/home">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-home text-muted fs-1"><span class="path1"></span><span
                                    class="path2"></span></i>
                        </span>
                        <span class="menu-title">Acceuil</span>
                    </a>
                </div>
                @if(auth()->user()->hasAnyPermission(['inventories', 'sorties', 'entries','categories','unities']))
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Gestions des Actifs</span>
                    </div>
                </div>
                @can('inventories')
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('inventories.index') }}">
                        <span class="menu-icon">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-purchase text-muted fs-1"><span class="path1"></span><span
                                        class="path2"></span></i>
                            </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('sorties.index') }}">
                        <span class="menu-icon">
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-courier text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('entries.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-parcel text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                                <!--end::Svg Icon-->
                            </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('categories.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-book text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('unities.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-note text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                @endcan
                @endif
                @if(auth()->user()->hasAnyPermission(['tasks', 'projects']))
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('projects.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-briefcase text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                    ...
                    <a class="menu-link" href="{{ route('tasks.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-clipboard text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                @if(auth()->user()->hasAnyPermission('teams','techniciens'))
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('teams.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-user-tick text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('technicians.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-people text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                ...
                @endcan
                @if(auth()->user()->hasAnyPermission(['maintenances', 'calendar', 'equipment']))
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link" href="{{ route('calendars.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-calendar text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
                    ...
                    <a class="menu-link" href="{{ route('equipments.index') }}">
                        <span class="menu-icon">
                            ...
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <i class="ki-duotone ki-laptop text-muted fs-1"><span class="path1"></span><span
                                            class="path2"></span></i>
                                </span>
                            </span>
               ...
               @endrole
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('repports.index') }}">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-delivery-time fs-3 position-absolute"><span class="path1"></span><span
                                    class="path2"></span></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('googlemaps.index') }}">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-delivery-time fs-3 position-absolute"><span class="path1"></span><span
                                    class="path2"></span></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('regions.index') }}">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-pointers fs-3 position-absolute"><span class="path1"></span><span
                                    class="path2"></span></i>
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('engins.index') }}">
                        <span class="menu-icon">
                            <i class="ki-duotone ki-car fs-3 position-absolute"><span class="path1"></span><span
                                    class="path2"></span></i>
                        </span>
                        <span class="menu-title">Engins roulants</span>
                    </a>
                </div>
                @endrole
                @can('priority')
    ...
    <div class="aside-footer flex-column-auto py-5" id="kt_aside_footer">
        ...
        <a href="{{ route('calendars.index') }}" class="btn btn-custom btn-primary w-100" data-bs-toggle="tooltip"
            data-bs-trigger="hover" data-bs-dismiss-="click" title="calendrier de travail">
            <span class="menu-icon">
                <span class="menu-icon">
                    <i class="ki-duotone ki-calendar text-muted fs-1"><span class="path1"></span><span
                            class="path2"></span></i>
