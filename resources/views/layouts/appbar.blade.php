    ...
    <div class="toolbar">
        ...
        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0 text-uppercase"> @yield('contentSubTitle')</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="/home" class="text-muted text-hover-primary">Acceuil</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
            ...
            <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        <!--begin::Action-->
                        <a href="{{ route('settings') }}" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-6">
                                        <a href="{{ route('categories.index') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
                                            ...
                                            <span class="fs-7 text-gray-400">Materiels</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('home') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
                                            ...
                                            <span class="fs-7 text-gray-400">Rapports</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('users.index') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                            ...
                                            <!--end::Svg Icon-->
                                            <span class="fs-5 fw-bold text-gray-800 mb-0">Utilisateurs</span>
                                            <span class="fs-7 text-gray-400">App</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                    <!--begin:Item-->
                                    <div class="col-6">
                                        <a href="{{ route('technicians.index') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
                                            ...
                                            <!--end::Svg Icon-->
                                            <span class="fs-5 fw-bold text-gray-800 mb-0">Techniciens</span>
                                            <span class="fs-7 text-gray-400">listes de techniciens</span>
                                        </a>
                                    </div>
                                    <!--end:Item-->
                                </div>
