                                            ...
                                            <div class="row">
                                               ...
                                               <div class="row">
                                                 <div class="col-md-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="">
                                                        <select name="unity_id"  aria-label="Selectionne une unité"
                                                 ...
                                                 <div class="col-md-6">
                                                    ...
                                                    <!--begin::Col-->
                                                    <div class="">
                                                        <select name="type"  aria-label="Selectionne un type d'équipement"
                                                            data-control="select2"
                                                            data-placeholder="Selectionner une type..."
                                                            class="form-select form-select-solid form-select-lg fw-bold"
                                                            data-dropdown-parent="#kt_modal_add_user"
                                                            data-allow-clear="true">
                                                            <option value="">Selectionner un équipement...</option>
                                                            <option value="Outils de travail">Outils de travail</option>
            ...
            <div class="card-body py-4">
                ...
                ">
                                    ...
                                    <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                        ...
                                        <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                        colspan="1" style="width: 85px;"
                                        aria-label="Connexion: activate to sort column ascending">Type</th>
